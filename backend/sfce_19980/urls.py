...
admin.site.site_header = "sfce"
admin.site.site_title = "sfce Admin Portal"
admin.site.index_title = "sfce Admin"

# swagger
api_info = openapi.Info(
    title="sfce API",
    default_version="v1",
    description="API documentation for sfce App",
)
